...
<body>
      ...
      <div id="delete-modal" class="delete-modal-overlay" style="display: none;">
        <div class="delete-modal-content">
          ...
          <div class="delete-modal-footer">
            ...
            <button class="confirm-btn" onclick="deleteModalBackend(reagentID)">Delete</button>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    function deleteModalBackend(reagentID) {
      location.href = "./delete_reagent.php?id=" + reagentID;
    }
  </script>
</body>
