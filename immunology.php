...
$sql_reagent_type = "SELECT COUNT(*) AS total_reagents 
                     FROM reagents 
                     WHERE reagent_status = 'active' AND reagent_type = 'immunology'";
...
$sql_card_value = "
    ...
    WHERE r.reagent_type = 'immunology' 
...
<body>
    ...
    <div class="container-fluid">
                ...
                <div class="nav-list-container">
                    <ul class="nav-list">
                        ...
                        <div class="submenu">
                            ...
                            <a href="#" class="reagent-name submenu-active">Immunology</a>
                        </div>
        ...
        <!-- Start of Header -->
        <div class="header">
            <h1 id="header-title">Immunology</h1>
                ...
                <div class="modal-content">
                    ...
                    <form id="mainForm" action="./add_reagents.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="two-column">
                            ...
                            <input type="hidden" name="reagent_type" id="reagent_type" value="immunology">
